...
class TSPGeneticAlgorithmOMP : public geneticAlgorithm {
 private:
 ...
 public:
  explicit TSPGeneticAlgorithmOMP();
  explicit TSPGeneticAlgorithmOMP(int seed_);
  explicit TSPGeneticAlgorithmOMP(int seed_, double crossoverProbability_, double mutationProbability_);
...
template
class TSPGeneticAlgorithmOMP<int, int>;
template
class TSPGeneticAlgorithmOMP<int, double>;
template
class TSPGeneticAlgorithmOMP<unsigned long long, double>;
